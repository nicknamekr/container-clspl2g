...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-clspl2g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-clspl2g.containers.anotherwebservice.com/
...
```
git clone git@github.com:nicknamekr/container-clspl2g.git
cd container-clspl2g
```
...
```
docker attach container-clspl2g
```
